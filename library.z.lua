...
local King = Instance.new("ScreenGui", game.CoreGui)
local LSTMArchive = Instance.new("TextLabel", King)
local player = game.Players.LocalPlayer

King.Name = "King"
King.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
King.Enabled = true
LSTMArchive.Name = "LSTMArchive"
LSTMArchive.BackgroundColor3 = Color3.new(1, 1, 1)
LSTMArchive.BackgroundTransparency = 1
LSTMArchive.BorderColor3 = Color3.new(0, 0, 0)
LSTMArchive.Position = UDim2.new(0.80, 0.80, 0.00090, 0)
LSTMArchive.Size = UDim2.new(0, 33, 0, 33)
LSTMArchive.Font = Enum.Font.GothamSemibold
LSTMArchive.Text = "TextLabel"
LSTMArchive.TextColor3 = Color3.new(1, 1, 1)
LSTMArchive.TextScaled = true
LSTMArchive.TextSize = 14
LSTMArchive.TextWrapped = true
LSTMArchive.Visible = true
...
local function HeartbeatUpdate()
    ...
    FpsLabel.Text = ("LSTM Archive Dear users of the LSTM Archive"..game.Players.LocalPlayer.DisplayName)

    if tick() - (LastIteration - 0.5) > 0 then
        FpsLabel.TextColor3 = ColorSequence[ColorIndex]
